...
namespace MakeItCreative\Middleware;

use MakeItCreative\Exception\ResponseException;
use MakeItCreative\Exception\SignatureException;
use MakeItCreative\Responses\PsrResponseFactory;
...
class GlideMiddleware implements EventDispatcherInterface
{
     ...
     *
     * @throws \MakeItCreative\Exception\SignatureException
     *
     * @return void
     */
     ...
     *
     * @throws \MakeItCreative\Exception\ResponseException
     *
